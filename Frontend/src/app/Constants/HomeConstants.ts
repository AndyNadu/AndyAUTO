export class HomeConstants {
  ...
  readonly leasingDescription: string = `
  Purchase a new vehicle, a certified pre-owned car, or a fleet of vehicles for your business through the auto financing program offered by AndyAUTO, your trusted dealership partner. You will enjoy completely transparent costs, fully deductible expenses and VAT, as well as excellent protection through insurance services integrated into our partner network. At AndyAUTO, we're committed to providing you with top-quality vehicles and exceptional service every step of the way.`
